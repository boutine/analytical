...
describe "Analytical::Modules::SegmentIo" do
  ...
  describe '#identify' do
    it 'should return a js string' do
      ...
      @api.segment_identify('id', { :email => 'test@test.com', :attribute_1 => "Some Value", :attribute_2 => "Some Other Value"} ).should == "seg.identify(\"test@test.com\", {\"attribute_1\":\"Some Value\",\"attribute_2\":\"Some Other Value\"});"
    end
  end
  describe '#track' do
    it 'should return a js string' do
